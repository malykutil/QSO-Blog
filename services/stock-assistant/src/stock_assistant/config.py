...
class Settings(BaseSettings):
    ...
    agent_initial_cash: float = Field(default=1_000.0, gt=0)
    agent_europe_initial_cash: float = Field(default=1_000.0, gt=0)
    ...
    agent_max_symbol_exposure: float = Field(default=0.10, gt=0, le=0.50)
    agent_min_score: int = Field(default=75, ge=50, le=100)
    agent_learning_rate: float = Field(default=0.12, ge=0.01, le=0.50)
    agent_drawdown_risk_reduction: float = Field(default=0.03, ge=0.01, le=0.10)
    agent_drawdown_pause: float = Field(default=0.08, ge=0.03, le=0.25)
    agent_high_volatility_risk_per_trade: float = Field(default=0.005, ge=0.0025, le=0.01)
    ...
    agent_high_volatility_max_symbol_exposure: float = Field(default=0.10, gt=0, le=0.50)
