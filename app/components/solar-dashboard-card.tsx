...
type SolarDashboardPayload = { alarmActive?: boolean; telemetry: { battery_current?: number | null; solar_total_current?: number | null; mq9_raw?: number | null; recorded_at: string } | null; relays: Record<string, boolean> };
